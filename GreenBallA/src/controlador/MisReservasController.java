...
public class MisReservasController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        DiaCol.setCellFactory(new Callback<TableColumn<Booking, String>, TableCell<Booking, String>>() {
            @Override
            public TableCell<Booking, String> call(TableColumn<Booking, String> param) {
                return new TableCell<Booking, String>() {
                    ...
                    protected void updateItem(String item, boolean empty) {
                        ...
                        if (item == null || empty) {
                            setText(null);
                            setStyle(""); // Restablecer cualquier estilo previo
                        } else {
                            setText(item);
                            setStyle("-fx-font-family: 'Bauhaus 93';-fx-font-size: 15px; -fx-text-fill: #4a6dcc;"); // Cambiar el color del texto a rojo
                            // Puedes agregar cualquier otra propiedad CSS según tus necesidades
        ...
        horaCol.setCellFactory(new Callback<TableColumn<Booking, String>, TableCell<Booking, String>>() {
            @Override
            public TableCell<Booking, String> call(TableColumn<Booking, String> param) {
                return new TableCell<Booking, String>() {
                    @Override
        ...
        estadoCol.setCellFactory(new Callback<TableColumn<Booking, String>, TableCell<Booking, String>>() {
            @Override
            public TableCell<Booking, String> call(TableColumn<Booking, String> param) {
                return new TableCell<Booking, String>() {
                    @Override
        ...
        pistaCol.setCellFactory(new Callback<TableColumn<Booking, String>, TableCell<Booking, String>>() {
            @Override
            public TableCell<Booking, String> call(TableColumn<Booking, String> param) {
                return new TableCell<Booking, String>() {
                    @Override
                ...
                if (booking != null) {
                    try {
                        ...
                        if(miembro.getCreditCard().equals("")){
                            ...
                            alert.setHeaderText("No tienes datos de pago");
                ...
                if (booking != null) {
                    try {
                        if(booking.getMadeForDay().equals(LocalDate.now()) || 
                            ...
                            alert.setContentText("¿Seguro que desea eliminar la reserva?");
