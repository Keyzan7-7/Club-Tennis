...
public class ModificarDatosController implements Initializable {
    ...
    private BooleanProperty nombreDif;
    private BooleanProperty apellidosDif;
    private BooleanProperty telefonoDif;
    private BooleanProperty imagenDif;
    private BooleanProperty passwordDif;
    private BooleanProperty reppasswordDif;
    private BooleanProperty tarjetaDif;
    private BooleanProperty svcDif;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        nombreDif = new SimpleBooleanProperty();
        apellidosDif = new SimpleBooleanProperty();
        telefonoDif = new SimpleBooleanProperty();
        imagenDif = new SimpleBooleanProperty();
        passwordDif = new SimpleBooleanProperty();
        reppasswordDif = new SimpleBooleanProperty();
        tarjetaDif = new SimpleBooleanProperty();
        svcDif = new SimpleBooleanProperty();
        
        nombreDif.setValue(Boolean.FALSE);
        apellidosDif.setValue(Boolean.FALSE);
        telefonoDif.setValue(Boolean.FALSE);
        imagenDif.setValue(Boolean.FALSE);
        passwordDif.setValue(Boolean.FALSE);
        reppasswordDif.setValue(Boolean.FALSE);
        tarjetaDif.setValue(Boolean.FALSE);
        svcDif.setValue(Boolean.FALSE);
        ...
        BooleanBinding campoDif = nombreDif.or(apellidosDif).or(telefonoDif).or(imagenDif).or(passwordDif).or(reppasswordDif).or(tarjetaDif).or(svcDif);
        ...
        confirmarButton.disableProperty().bind(Bindings.not(camposCorrect.and(campoDif)));
        cancelButton.disableProperty().bind(Bindings.not(campoDif));
        ...
        nombreField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if(!newValue.equals(miembro.getName())){
                nombreDif.setValue(Boolean.TRUE);
            } else{
                nombreDif.setValue(Boolean.FALSE);
            }
        });
        ...
        apellidosField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if(!newValue.equals(miembro.getSurname())){
                apellidosDif.setValue(Boolean.TRUE);
            } else{
                apellidosDif.setValue(Boolean.FALSE);
            }
        });
        ...
        telefonoField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if(!newValue.equals(miembro.getTelephone())){
                telefonoDif.setValue(Boolean.TRUE);
            } else{
                telefonoDif.setValue(Boolean.FALSE);
            }
        });
        ...
        passwordField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if(!newValue.equals(miembro.getPassword())){
                passwordDif.setValue(Boolean.TRUE);
            } else{
                passwordDif.setValue(Boolean.FALSE);
            }
        });
        ...
        reppasswordField.textProperty().addListener((observable, oldValue, newValue) -> {
           //reppassText.setText(newValue);
            ...
            if(!newValue.equals(miembro.getPassword())){
                reppasswordDif.setValue(Boolean.TRUE);
            } else{
                reppasswordDif.setValue(Boolean.FALSE);
            }
        });
        ...
        tarjetaField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if(!newValue.equals(miembro.getCreditCard())){
                tarjetaDif.setValue(Boolean.TRUE);
            } else{
                tarjetaDif.setValue(Boolean.FALSE);
            }
        });
        ...
        svcField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if(!newValue.equals(String.valueOf(miembro.getSvc()))){
                svcDif.setValue(Boolean.TRUE);
            } else{
                svcDif.setValue(Boolean.FALSE);
            }
        });
    ...
    private void confirmar(ActionEvent event) throws IOException, ClubDAOException, InterruptedException {
        ...
        alert.setTitle("Confirmación cambio de datos");
        //alert.setHeaderText(null);
        alert.setHeaderText("Vas a cambiar tus datos guardados");
        alert.setContentText("¿Estás seguro de que quieres cambiar tus datos?");
        ...
        miembro.setPassword(passwordField.getText());
        miembro.setCreditCard(tarjetaField.getText());
        if(!tarjetaField.getText().equals("")){
            miembro.setSvc(Integer.parseInt(svcField.getText()));
        } else{
            miembro.setSvc(0);
        }
        miembro.setImage(imagen);
    ...
    private void cancelar(ActionEvent event) throws IOException {
        nombreField.setText(miembro.getName());
        apellidosField.setText(miembro.getSurname());
        telefonoField.setText(miembro.getTelephone());
        nicknameField.setText(miembro.getNickName());
        passwordField.setText(miembro.getPassword());
        reppasswordField.setText(miembro.getPassword());
        tarjetaField.setText(miembro.getCreditCard());
        if(miembro.getCreditCard().equals("")){
            svcField.setText("");
        } else{
            svcField.setText(String.valueOf(miembro.getSvc()));
        }
        circuloAvatar.setFill(new ImagePattern(miembro.getImage()));
    ...
    private void cambiarImagen(MouseEvent event) {
        ...
        if (selectedFile != null) {
            ...
            if(!compareImages(imagen, miembro.getImage())){
                imagenDif.setValue(Boolean.TRUE);
            } else{
                imagenDif.setValue(Boolean.FALSE);
            }
    ...
    private void showPass2(ActionEvent event) {
        if (showRepPass.isSelected()) {
                ...
                reppasswordField.setStyle("-fx-text-fill: transparent;");
                reppassText.setStyle("-fx-text-fill: black;");
                ...
                reppassText.setStyle("-fx-text-fill: transparent;");
                reppasswordField.setStyle("-fx-text-fill: black;");
            }
    }
    ...
    public void setMember(Member x){
        ...
        nicknameField.setText(miembro.getNickName());
        passwordField.setText(miembro.getPassword());
        passText.setText(miembro.getPassword());
        reppasswordField.setText(miembro.getPassword());
        reppassText.setText(miembro.getPassword());
        tarjetaField.setText(miembro.getCreditCard());
        if(miembro.getCreditCard().equals("")){
            svcField.setText("");
        } else{
    ...
    private boolean compareImages(Image image1, Image image2) {
        if (image1.getWidth() != image2.getWidth() || image1.getHeight() != image2.getHeight()) {
            return false; // Las dimensiones de las imágenes son diferentes
        }
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                if (!color1.equals(color2)) {
                    return false; // Los colores de los píxeles son diferentes
                }
            }
        }
    ...
    @FXML
    private void toReservas(ActionEvent event) throws IOException {
    ...
    private void salir(MouseEvent event) {
        imagenLabel2.setPrefHeight(0);
    }

    @FXML
    private void entrar(MouseEvent event) {
        imagenLabel2.setPrefHeight(40);
    }
  @FXML
